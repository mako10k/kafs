...
| M8-B | Create and directory-record mutation | In progress: two-to-three-block growth complete; existing three-block append remains |
...
not general writable filesystem readiness. Existing three-block directory
append, further direct-block growth, general create placement, indirect blocks,
