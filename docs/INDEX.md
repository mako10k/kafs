...
- [sd-card-wear-v7-migration-evidence.md](sd-card-wear-v7-migration-evidence.md): T59-A v5-to-v7 source, copy, destination, resume, rollback, and acceptance evidence contract
