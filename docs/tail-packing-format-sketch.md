...
ここに 16-byte tail descriptor を inode growth で追加すると、新 inode は 130 bytes になる。

- current inode bytes: 114
- proposed inode bytes: 130
- delta per inode: 16
- relative growth: 約 14.0%
...
|-------------|---------------------|-------------------|-------|
| 65,536 | 7,471,104 | 8,519,680 | 1,048,576 |
| 262,144 | 29,884,416 | 34,078,720 | 4,194,304 |
| 1,048,576 | 119,537,664 | 136,314,880 | 16,777,216 |

MiB 換算ではそれぞれおよそ次になる。

- 65,536 inode: 7.125 MiB -> 8.125 MiB
- 262,144 inode: 28.5 MiB -> 32.5 MiB
- 1,048,576 inode: 114.0 MiB -> 130.0 MiB
