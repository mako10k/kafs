...
static void
kafs_dirent_filename_set (struct kafs_sdirent *dirent, const char *filename)
{
...
static void
kafs_dirent_set (struct kafs_sdirent *dirent, kafs_inocnt_t ino, const char *filename)
{
